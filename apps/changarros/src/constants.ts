...
export const CATEGORIES: Category[] = [
  { id: 'all', label: 'Todo', imageUrl: 'https://picsum.photos/seed/all/100/100' },
  { id: 'home', label: 'Hogar', imageUrl: 'https://picsum.photos/seed/home/100/100' },
  { id: 'ceramic', label: 'Cerámica', imageUrl: 'https://picsum.photos/seed/ceramic/100/100' },
  { id: 'textile', label: 'Textiles', imageUrl: 'https://picsum.photos/seed/textile/100/100' },
  { id: 'vintage', label: 'Vintage', imageUrl: 'https://picsum.photos/seed/vintage/100/100' },
  { id: 'plants', label: 'Botánica', imageUrl: 'https://picsum.photos/seed/plants/100/100' },
];

export const PRODUCTS: Product[] = [
  {
    id: '1',
    title: 'Jarrón Wabi Sabi',
    price: 450,
    description: 'Jarrón de cerámica hecho a mano con acabado rústico e imperfecto que celebra la belleza de lo natural. Perfecto para flores secas o ramas de eucalipto.',
    category: 'ceramic',
    images: [
  ...
  {
    id: '2',
    title: 'Cobija de Lana Cruda',
    price: 1200,
    description: 'Tejida en telar de cintura por artesanos locales. 100% lana virgen, suave y increíblemente cálida para las noches frías.',
    category: 'textile',
    images: [
  ...
  {
    id: '3',
    title: 'Espejo Vintage Dorado',
    price: 850,
    description: 'Espejo de latón recuperado de los años 70. Una pieza única con historia que aporta luz y amplitud a cualquier rincón.',
    category: 'vintage',
    images: [
  ...
  },
  {
    ...
    price: 350,
    description: 'Planta de interior resistente y purificadora de aire. Sus hojas fenestradas son una obra de arte natural. Viene en maceta de barro básica.',
    category: 'plants',
    images: [
  ...
  {
    id: '5',
    title: 'Juego de Tazas Terra',
    price: 500,
    description: 'Set de 4 tazas de café en tonos tierra. Esmalte mate apto para lavavajillas. El agarre es ergonómico y conservan bien el calor.',
    category: 'ceramic',
    images: [
  ...
  },
  {
    ...
    title: 'Cesta de Yute',
    price: 300,
    description: 'Cesta organizadora tejida a mano con fibras naturales. Ideal para revistas, mantas o como macetero decorativo.',
    category: 'home',
    images: [
  ...
  {
    id: '7',
    title: 'Lámpara de Mesa Hongo',
    price: 1500,
    description: 'Diseño icónico en vidrio soplado color ámbar. Luz cálida para ambientes relajados. Inspirada en el diseño italiano de los 60s.',
    category: 'vintage',
    images: [
  ...
  {
    id: '8',
    title: 'Mantel de Lino Lavado',
    price: 950,
    description: 'Lino europeo pre-lavado para una textura suave y arrugada "effortless". Color arena natural que combina con todo.',
    category: 'textile',
    images: [

...
export const BazaarConcierge: React.FC = () => {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    { role: 'model', text: '¡Hola! Bienvenid@ a Bazar Aura. 🌿 ¿Buscas algo especial para tu hogar o un regalo único?' }
  ]);
          ...
          <div className="bg-stone-100 p-4 flex justify-between items-center border-b border-stone-200">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-stone-300 overflow-hidden">
                 <img src="https://picsum.photos/seed/avatar/100/100" alt="Aura" className="w-full h-full object-cover" />
              </div>
              <div>
            ...
            <button onClick={toggleChat} className="text-stone-400 hover:text-stone-700">
              <X size={20} />
            </button>
          </div>
